...
const renderCalendar = (contextMonth, contextYear) => {
    ...
    const firstDayOfThisMonth = new Date(contextYear, contextDate.getMonth(), 1);
    const lastDayOfThisMonth = new Date(contextYear, contextDate.getMonth() + 1, 0);
    const currentDayOfTheWeek = firstDayOfThisMonth.getDay();
    const lastDateOfPrevMonth = new Date(2021, contextDate.getMonth(), 0).getDate();
    if (monthNameElement) {
